...
function OptOutAutomationContent() {
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Please select a brand and channel to configure opt-out automation
              </p>
              <button
      ...
      <div className={`fixed right-0 top-0 bottom-0 flex flex-col bg-white dark:bg-gray-900 transition-all duration-300 ${isCollapsed ? 'left-20' : 'left-64'}`}>
        ...
        <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-4 py-2.5 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="w-px h-4 bg-gray-300 dark:bg-gray-700"></div>
            <div className="flex items-center gap-2">
              <span className="text-red-600 dark:text-red-400 text-xs font-semibold">📤 OPT-OUT AUTOMATION</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-hidden">
          <FlowBuilder automationType="opt-out" />
        </div>
      </div>
    </>
  );
...
export default function OptOutAutomation() {
  return (
    <ProtectedRoute>
      <OptOutAutomationContent />
    </ProtectedRoute>
  );
}
