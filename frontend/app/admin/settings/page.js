  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Feature flags, limits, API keys, and admin accounts.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">Enable or disable features across the platform.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">API Keys & Secrets</h3>
            <p className="text-sm text-gray-600 mt-1">Manage external service credentials.</p>
          </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">Configure limits for each subscription plan.</p>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Free Plan */}
            <div className="p-4 border border-gray-200 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-4">Free Plan</h4>
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs text-gray-500">Bots</label>
                  <input
                    type="number"
                    defaultValue={1}
                    className="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg text-sm"
                ...
                <div>
                  <label className="text-xs text-gray-500">Automations</label>
                  <input
                    type="number"
                    defaultValue={3}
                    className="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg text-sm"
            ...
            <div className="p-4 border border-blue-200 bg-blue-50/50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-4">Starter Plan</h4>
              <div className="space-y-3">
                <div>
                  <label className="text-xs text-gray-500">Messages/month</label>
                  <input
            ...
            <div className="p-4 border border-purple-200 bg-purple-50/50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-4">Pro Plan</h4>
              <div className="space-y-3">
                <div>
                  <label className="text-xs text-gray-500">Messages/month</label>
                  <input
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Manage who can access the admin panel.</p>
          </div>
          <button className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">
            Add Admin
          </button>
            ...
            <tbody className="divide-y divide-gray-200">
              {adminAccounts.map((admin, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <p className="text-sm text-gray-600">{admin.lastActive}</p>
                  </td>
                  <td className="px-6 py-4">
      ...
      <div className="bg-red-50 border border-red-200 rounded-xl p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <button className="px-4 py-2 text-sm font-medium text-red-700 border border-red-300 rounded-lg hover:bg-red-100">
            Clear All Logs
          </button>
          <button className="px-4 py-2 text-sm font-medium text-red-700 border border-red-300 rounded-lg hover:bg-red-100">
            Reset Feature Flags
