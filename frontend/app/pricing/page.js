  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-20 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="absolute -top-16 -left-16 w-56 h-56 bg-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-25 animate-float"></div>
        ...
        <div className="absolute -bottom-12 left-1/4 w-40 h-40 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"></div>
