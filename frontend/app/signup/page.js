      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-12 text-center">
          <Link href="/" className="inline-flex items-center gap-2 mb-8 hover:opacity-70 transition-opacity">
            <div className="w-10 h-10 border border-black rounded-lg flex items-center justify-center font-mono text-sm font-bold">
              DM
            </div>
          </Link>
          <h1 className="text-2xl font-bold text-black mb-2">Create your account</h1>
          <p className="text-sm text-gray-600">Start automating your DMs for free</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start">
              <input
                ...
                id="terms"
                required
                className="w-4 h-4 border-gray-300 mt-1"
              />
