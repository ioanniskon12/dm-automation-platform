...
function StoryMentionReplyContent() {
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Please select a brand and channel to configure story mention reply automation
              </p>
              <button
      ...
      <div className={`fixed right-0 top-0 bottom-0 flex flex-col bg-white dark:bg-gray-900 transition-all duration-300 ${isCollapsed ? 'left-20' : 'left-64'}`}>
        ...
        <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-4 py-2.5 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="w-px h-4 bg-gray-300 dark:bg-gray-700"></div>
            <div className="flex items-center gap-2">
              <span className="text-purple-600 dark:text-purple-400 text-xs font-semibold">📖 STORY MENTION REPLY</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-hidden">
          <FlowBuilder automationType="story-mention" prePopulatedTrigger="story_mention" />
        </div>
      </div>
    </>
  );
...
export default function StoryMentionReply() {
  return (
    <ProtectedRoute>
      <StoryMentionReplyContent />
    </ProtectedRoute>
  );
}
