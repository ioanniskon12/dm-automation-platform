...
// ALERT BOX COMPONENT
// ============================================
const alertBox = (message: string, type: 'warning' | 'info' | 'success' | 'error' = 'info') => {
  const colors = {
...
export const emailTemplates = {
  ...
  // New Login Alert
  newLoginAlert: (name: string, deviceInfo: { browser: string; os: string; ip: string; location?: string }) => ({
  ...
  weeklyReport: (name: string, stats: { messages: number; automations: number; engagement: string; topFlow: string }) => ({
