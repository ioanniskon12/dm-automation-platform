...
const getBrandDocuments = (brandId) => {
...
export default async function (fastify) {
    ...
    fastify.post('/upload', async (request, reply) => {
        try {
            ...
            else if (data.mimetype.includes('word'))
                fileType = 'Word Document';
            else if (data.mimetype === 'text/plain')
                fileType = 'Text File';
            else if (data.mimetype === 'text/csv')
                fileType = 'CSV File';
            else if (data.mimetype.includes('excel') || data.mimetype.includes('spreadsheet'))
                fileType = 'Excel File';
    ...
    const extractUrlsFromHtml = (html, baseUrl) => {
        const urls = new Set();
    ...
    const crawlWebsite = async (startUrl, maxPages = 50) => {
