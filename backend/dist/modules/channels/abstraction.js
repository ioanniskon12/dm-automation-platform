export class ChannelAbstraction {
     ...
     */
    async sendMessage(channel, channelId, userId, message) {
        try {
     ...
     */
    adaptMessage(message, capabilities) {
     ...
     * Instagram sender
     */
    async sendInstagram(channelId, userId, message) {
     ...
     * Messenger sender
     */
    async sendMessenger(channelId, userId, message) {
     ...
     * WhatsApp sender
     */
    async sendWhatsApp(channelId, userId, message) {
     ...
     * Telegram sender
     */
    async sendTelegram(channelId, userId, message) {
     ...
     * Twitter / X sender
     */
    async sendTwitter(channelId, userId, message) {
     ...
     */
    formatInstagramMessage(message) {
        const formatted = {};
        if (message.text) {
     ...
     */
    formatMessengerMessage(message) {
        const formatted = {};
        if (message.text) {
            formatted.text = message.text;
        }
     ...
     */
    normalizeInboundMessage(channel, rawPayload) {
        switch (channel) {
            case 'instagram':
    ...
    normalizeWhatsAppInbound(payload) {
        return {
            userId: payload.from || '',
    ...
    normalizeTelegramInbound(payload) {
        return {
    ...
    normalizeTwitterInbound(payload) {
        return {
